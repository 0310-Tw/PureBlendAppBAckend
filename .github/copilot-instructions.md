...
_Last synced: 2026-03-26T00:44:52.968Z._
...
- `c:\pure_blend_smoothie_app\backend\.vscode\mcp.json` _(workspace: backend)_ — _file missing_

_No active workspace servers in mcp.json._

#### User MCP

- `C:\Users\taric\AppData\Roaming\Code\User\mcp.json` — _file missing_
